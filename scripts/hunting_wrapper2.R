#' Lotka-Volterra (Hunting: Scenario Two) Model Wrapper Function
#'
...
hunting_wrapper2 <- function(h, V_thresh, b, alpha, d, K_v, K_p, c,
                             initial_state, years,
  ...
  #run the constant harvest model with closure for 50 years
  output <- lotka_volterra2(initial_states = initial_state,
                            years = years,
                            params = params)
