#' Lotka-Volterra (Scenario Three: Adaptive Management) Model Simulation
#'
#' simulates the dynamics of a predator-prey system using a discrete-time Lotka-Volterra model with logistic prey growth, predator carrying capacity, proportional prey harvest (biomass-based hunting), a biomass-closure threshold, and adaptive management
#' 
...
#' @author Jaden Orli
#' @return a data frame with columns \code{year}, \code{prey}, and \code{predator}, \code{hunting}, \code{hunt_amount}, and \code{hunt_rate}
